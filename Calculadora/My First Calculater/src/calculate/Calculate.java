...
public class Calculate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Casilla.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        this.firstnumber=Float.parseFloat(this.Casilla.getText());
        this.Operador="+";
        this.Casilla.setText("");// TODO add your handling code here:
    }//GEN-LAST:event_jButton17ActionPerformed

    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        this.secondnumber=Float.parseFloat(this.Casilla.getText());
        switch(this.Operador){
            case "+":this.Casilla.setText(sincero(this.firstnumber+this.secondnumber));break;
            case "-":this.Casilla.setText(sincero(this.firstnumber-this.secondnumber));break;
            case "*":this.Casilla.setText(sincero(this.firstnumber*this.secondnumber));break;
            case "/":this.Casilla.setText(sincero(this.firstnumber/this.secondnumber));break;
